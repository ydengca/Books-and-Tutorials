...
, [ContactFullName] nvarchar(101) Not Null -- Combined data
, [CompanyName] nvarchar(128) Not Null
, [SalesPersonAlias] nvarchar(256) Not Null -- Split data
);
go
...
, [ContactFirstName] = [FirstName] + ' ' + [LastName]
, [CompanyName] = [CompanyName]
, [SalesPersonAlias] = Substring([SalesPerson], PatIndex('%\%',[SalesPerson]) + 1, 256 )
FROM [AdventureWorksLT2012].[SalesLT].[Customer]
;
go
